...
export const AASA_PATHS: string[];
export const WELL_KNOWN_APP_LINK_PATHS: string[];
export function resolveAppleTeamId(env?: NodeJS.ProcessEnv): string;
export function resolveAndroidSha256Fingerprints(env?: NodeJS.ProcessEnv): string[];
