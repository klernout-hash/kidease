    ...
    vars: [
      {
        ...
        vercel: "both",
        required: false,
        notes: "Bearer for /api/digest (also one-time verify-email nudge), /api/search-alerts, /api/tour-holds, /api/seed-catalog, /api/docusign/poll.",
      },
      {
        name: "SENTRY_DSN",
        concealed: true,
      ...
      },
      {
        ...
        vercel: "both",
        required: false,
        notes: "Optional kill switch. Unset = on. Set 0 to disable GHL API and webhook POSTs.",
      },
      {
        name: "GHL_API_TOKEN",
        concealed: true,
        vercel: "both",
        required: false,
        notes: "LeadConnector Private Integration token. When set, signup creates a contact and a Signed up opportunity. Never Approved.",
      },
      {
        ...
        vercel: "both",
        required: false,
        notes: "Defaults to KidEase Winnipeg hkAJnVH8EJpMcgq9bNjG. Casing matters.",
      },
      {
        name: "GHL_DAYCARE_PIPELINE_ID",
        concealed: false,
        vercel: "both",
        required: false,
        notes: "Optional override. Default Daycare Sign Up pipeline y95txOBNvB7hOMMcXggS.",
      },
      {
        name: "GHL_DAYCARE_SIGNED_UP_STAGE_ID",
        concealed: false,
        vercel: "both",
        required: false,
        notes: "Optional override. Default Signed up only. Never the Approved stage.",
      },
      {
        name: "GHL_PARENT_PIPELINE_ID",
        concealed: false,
        vercel: "both",
        required: false,
        notes: "Optional override. Default Parent Onboard pipeline EyzRc2UAWPVOqfdmkoYh.",
      },
      {
        name: "GHL_PARENT_SIGNED_UP_STAGE_ID",
        concealed: false,
        vercel: "both",
        required: false,
        notes: "Optional override. Default Signed up only. Never Approved.",
      },
      {
