      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Screening certificates (Vulnerable Sector Checks, Child Abuse Registry, Prior Contact) stay on the daycare and Admin desks. Parents never see the PDF or the person’s name. KidEase reviews files; it does not issue police checks.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Les certificats de filtrage (secteur vulnérable, registre des mauvais traitements, contacts antérieurs) restent sur les bureaux garderie et Admin. Les parents ne voient jamais le PDF ni le nom de la personne. KidEase examine les dossiers ; il ne délivre pas de contrôles policiers.",
