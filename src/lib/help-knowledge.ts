...
const REPLIES: Array<{ keys: string[]; lines: string[] }> = [
  ...
  },
  {
    ...
    lines: [
      "KidEase follows PIPEDA. We don’t sell your data. Child details you add are only for you and a centre you contact or book. Full note is on the Privacy page. Cookies and local storage are listed at /cookies — no advertising trackers, so no banner. Product analytics (PostHog) is privacy-masked session replay and page views, not ads.",
    ],
  },
  {
