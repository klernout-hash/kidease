...
export function CompareBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-20 z-30 border-t border-border bg-surface/95 px-[clamp(1rem,4vw,2rem)] py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-lift backdrop-blur-md md:bottom-0">
