      ...
      <main className="ke-gutter mx-auto max-w-3xl py-10">
        ...
        <section className="mt-8 rounded-xl bg-surface p-5 ring-1 ring-border md:p-6">
          ...
          <ul className="mt-2 list-disc space-y-2 pl-5 text-sm text-muted">
            <li>{fr ? "Les tarifs réduits sont fixés par la province ou le territoire et appliqués au centre participant \u2014 pas par KidEase." : "Reduced CWELCC fees are set by the province or territory and applied at participating licensed centres \u2014 not by KidEase."}</li>
            <li>{fr ? "En général, aucune demande CWELCC séparée : si le centre est dans le programme, le tarif réduit est déjà sur la facture." : "You usually do not file a separate CWELCC application. If the centre is in the program, the lower parent fee is already on their invoice."}</li>
